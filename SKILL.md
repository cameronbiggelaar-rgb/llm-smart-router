...
- **Beware circular sources.** Including the summary inside its own source makes precision trivially 1.0 — one validation run reported overlap **1.000 for all 118 pairs** and every top score was a meaningless 1.0. Exclude the summary from its own source and assert it.
